...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Tablice samochodu 1. " + car1);
        System.out.println("Tablice samochodu 2. " + car2);
        System.out.println("Tablice ciężarówki 1." + truck1);
        System.out.println("Tablice ciężarowki 2." + truck2);
        System.out.println("Tablice Motocykla 1." + motorcycle1);
        System.out.println("Tablice motocykla 2" + motorcycle2);
